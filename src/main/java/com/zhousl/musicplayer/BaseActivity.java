...
public abstract class BaseActivity extends AppCompatActivity {
    ...
    protected void changeStatusColor(@ColorRes int color) {
        mStatusBarFillView.setBackgroundColor(getResources().getColor(color));
    }
    protected void changeStatusHeight(int height){
        mStatusBarFillView.getLayoutParams().height=height;
        mStatusBarFillView.requestLayout();
    }
}
